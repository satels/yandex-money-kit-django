# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-07 02:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_id', models.PositiveIntegerField(default='151', verbose_name='ID магазина')),
                ('scid', models.PositiveIntegerField(default='363', verbose_name='Номер витрины')),
                ...
                ('success_url', models.URLField(default='/payments/success-payment/', verbose_name='URL успешной оплаты')),
                ('fail_url', models.URLField(default='/payments/fail-payment/', verbose_name='URL неуспешной оплаты')),
